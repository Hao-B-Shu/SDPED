...
from SDPED_Model import * # Import the model and loss the loss function here (The official loss function is put in the file of the corresponding model).
...
######################### All dirs should be built manually and codes for saving predictions are included in Others.py, not used here###########################
main(
...
torch.cuda.empty_cache()
###################################To save the predictions, please refer the codes in Other.py.##################################################
#################################################################################################################################################
