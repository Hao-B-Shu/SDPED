function [ODS,OIS,AP,R50]=benchmarkBoundary(edges_dir, gt_dir, name)
...
%benchmarkBoundary('The dir of the predictions, type: .png(0~225)', 'The dir of the groundtruthes, type: .mat(binary, 0 or 1)', 'The name (independent of results)')